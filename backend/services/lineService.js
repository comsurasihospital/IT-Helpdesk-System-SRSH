    ...
    contents: {
      ...
      body: {
        ...
        contents: [
          ...
          row('⏱ SLA',       ticket.sla_minutes ? (ticket.sla_minutes < 60 ? `${ticket.sla_minutes} นาที` : ticket.sla_minutes < 1440 ? `${ticket.sla_minutes/60} ชั่วโมง` : `${ticket.sla_minutes/1440} วัน`) : '-', '#DC2626'),
          sep(),
